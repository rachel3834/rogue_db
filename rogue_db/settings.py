...
Generated by ./manage.py tom_setup on Nov. 17, 2025, 5:28 p.m.
...
SECRET_KEY = '@!rgh=w_8-oe=j8ax(#yeu&amp;de7(v(8ibuk&amp;+4gc3v3p&amp;0^*9e%'
...
WSGI_APPLICATION = 'rogue_db.wsgi.application'
...
TARGET_MODEL_CLASS = 'custom_code.target_models.MicrolensingTarget'
